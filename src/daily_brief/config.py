...
# Batch scheduler settings — C.2a benchmark winner (4,2): 55.6% faster than baseline (3,1), no quality regression
LLM_SUMMARY_BATCH_SIZE = int(_get_nested(CONFIG_YAML, 'runtime_defaults.llm_summary_batch_size') or 4)
LLM_SUMMARY_MAX_CONCURRENCY = int(_get_nested(CONFIG_YAML, 'runtime_defaults.llm_summary_max_concurrency') or 2)
